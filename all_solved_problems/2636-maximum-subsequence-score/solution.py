class Solution:
    def maxScore(self, nums1: List[int], nums2: List[int], k: int) -> int:
        ...
        # rest will be put into the heap to get the smallest number
        rest = nums1_sorted[n - k:]

        # sum_rest will keep track of the total k numbers selected in nums1
        sum_rest = sum(rest)
        heapq.heapify(rest)
        ...
        for i in range(n - k - 1, -1, -1):
            ...
            # push the current number in and push the smallest number out
